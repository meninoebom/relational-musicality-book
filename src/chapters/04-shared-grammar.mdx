...
<Figure number="4.1" caption="Five choreo-musical forms mapped across five dimensions. Notice the full, similar shapes — these practices fill the space rather than specializing.">
...
<Figure number="4.2" caption="Other technologies of remembering. Each is valuable — but each specializes, producing spiky shapes rather than full ones.">
  <OverlayChart practices={OTHER_PRACTICES} />
</Figure>

Now look at what happens when we zoom in on a single dimension.

<Figure number="4.3" caption="Emergence: where practices fall on the dimension of creating together in the moment.">
...
<Figure number="4.4" caption="Embodiment: the body as a site of knowing.">
