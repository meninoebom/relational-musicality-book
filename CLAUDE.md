...
- **Aphoristic pith, anywhere (July 2026 calibration).** The broader version of the two rules above, from direct author feedback: short, stabby, pithy sentences and stacked fragments read as AI-generated writing, and so does prose that tries to sell or package an idea rather than get to its core. The register to aim for is thoughtful, introspective, sometimes critical nonfiction: full sentences that develop a thought with compassion for the reader and an interest in truth-finding, not punchlines. One quiet declarative landing after genuine exploration is Brandon's mode; a rhythm built out of them is not. When in doubt, fold fragments and doublets ("The tool would not change. The intent would.") into a flowing sentence and let the thought breathe. Narrow exception: cinematic scene-setting openers ("A conference room. Twelve people around a table.") are stage directions, not aphorisms, and may stay.
